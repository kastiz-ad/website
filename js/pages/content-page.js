...
if(PAGE==="early-access")trackEvent("early_access_viewed",{page:PAGE,language});
document.querySelectorAll(".request-form").forEach(formEl=>formEl.addEventListener("focusin",()=>{const eventName=PAGE==="early-access"?"early_access_started":PAGE==="partners"?"partner_inquiry_started":PAGE==="provider-standards"?"provider_inquiry_started":"contact_started";trackEvent(eventName,{page:PAGE,language,form_type:PAGE})},{once:true}));
