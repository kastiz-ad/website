...
import { resolvePreviewDestination } from "../engine/world/preview-destination-intelligence.js?v=20260812-one-button-alignment-v65";
...
const runLoadingSequence = async () => {
  ...
  window.setTimeout(() => {
    ...
    const resultsParams = new URLSearchParams({
      v: "20260812-one-button-alignment-v65",
