...
import { resolvePreviewDestination } from "../engine/world/preview-destination-intelligence.js?v=20260812-europe-airlines-paris-v60";
...
const runLoadingSequence = async () => {
  ...
  window.setTimeout(() => {
    ...
    const resultsParams = new URLSearchParams({
      v: "20260812-europe-airlines-paris-v60",
