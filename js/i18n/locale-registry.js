...
Object.assign(home.en, { outgoingDate: "Outgoing date", returningDate: "Returning date", time: "Time", travelDetails: "Travel details", close: "Close" });
Object.assign(home.ko, { outgoingDate: "출국 날짜", returningDate: "귀국 날짜", time: "시간", travelDetails: "여행 상세", close: "닫기" });
Object.assign(home.es, { outgoingDate: "Fecha de ida", returningDate: "Fecha de regreso", time: "Hora", travelDetails: "Detalles del viaje", close: "Cerrar" });
Object.assign(home.fr, { outgoingDate: "Date de départ", returningDate: "Date de retour", time: "Horaire", travelDetails: "Détails du voyage", close: "Fermer" });
