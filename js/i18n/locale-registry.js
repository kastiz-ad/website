...
const home = {
  ...
  es: { description: "Kastiz ONE convierte objetivos reales en misiones listas para tu aprobación.", siteNavigation: "Navegación de Kastiz ONE", preferences: "Preferencias", themeLabel: "Tema", languageLabel: "Idioma", loginWelcome: "Te damos la bienvenida a Kastiz ONE", loginComingSoon: "El acceso a cuentas se está habilitando gradualmente.", loginPriority: "Únete al acceso anticipado o solicita una invitación.", joinEarlyAccess: "Unirme al acceso anticipado", requestInvitation: "Solicitar invitación", contactSupport: "Contactar con soporte", notifyMe: "Avísame", notifyConfirmed: "Estás en la lista prioritaria.", scheduleTitle: "Elige fechas y horario", scheduleHelp: "Selecciona las fechas necesarias. El horario es opcional.", startDate: "Fecha de inicio", endDate: "Fecha de fin", timePreference: "Horario preferido", anyTime: "Cualquier hora / Sin preferencia", morning: "Mañana · 06:00–12:00", afternoon: "Tarde · 12:00–17:00", evening: "Noche · 17:00–22:00", confirmSchedule: "Confirmar y continuar", searchLabel: "Escribe tu misión", searchDefault: "Planea mi viaje a Japón.", missionTools: "Herramientas de misión", microphone: "Usar micrófono", uploadImage: "Subir imagen", aiPowered: "Con tecnología de IA", startMission: "Iniciar misión", footer: "Pie de página", unknownLocation: "Ubicación desconocida", travelerCount: "Viajeros", roomCount: "Habitaciones", departureAirport: "Aeropuerto de salida", missions: ["Planea mi viaje a Japón.", "Prepárame para la presentación de mañana.", "Prepárame para mi reunión con inversores.", "Ayúdame a aprobar el TOPIK 4.", "Prepara mi propuesta para el cliente.", "Investiga a la competencia y prepara un briefing.", "Prepárame para la entrevista de mañana.", "Ayúdame a iniciar un negocio."] }
};

home.fr = { ...home.en, description: "Kastiz ONE transforme vos objectifs concrets en missions prêtes à être approuvées.", siteNavigation: "Navigation Kastiz ONE", preferences: "Préférences", languageLabel: "Langue", themeLabel: "Thème", scheduleTitle: "Choisissez les dates et l’horaire", scheduleHelp: "Sélectionnez la période souhaitée. L’horaire est facultatif.", startDate: "Date de début", endDate: "Date de fin", timePreference: "Préférence horaire", anyTime: "Horaire flexible / Aucune préférence", morning: "Matin · 06:00–12:00", afternoon: "Après-midi · 12:00–17:00", evening: "Soir · 17:00–22:00", travelerCount: "Voyageurs", roomCount: "Chambres", departureAirport: "Aéroport de départ", confirmSchedule: "Confirmer et continuer", searchDefault: "Planifie mon voyage au Japon.", searchLabel: "Saisissez votre mission", missionTools: "Outils de mission", microphone: "Utiliser le microphone", uploadImage: "Importer une image", aiPowered: "Avec IA", startMission: "Démarrer la mission", footer: "Pied de page", unknownLocation: "Lieu inconnu", missions: ["Planifie mon voyage au Japon.", "Trouve un professeur d'anglais.", "Recommande le meilleur ordinateur portable.", "Aide-moi à créer une entreprise."] };
Object.assign(home.en, { outgoingDate: "Outgoing date", returningDate: "Returning date", time: "Time", travelDetails: "Travel details", close: "Close", currentLocation: "Current location", notSureYet: "Not sure yet" });
Object.assign(home.ko, { outgoingDate: "출국 날짜", returningDate: "귀국 날짜", time: "시간", travelDetails: "여행 상세", close: "닫기", currentLocation: "현재 위치", notSureYet: "아직 모르겠어요" });
Object.assign(home.es, { outgoingDate: "Fecha de ida", returningDate: "Fecha de regreso", time: "Hora", travelDetails: "Detalles del viaje", close: "Cerrar", currentLocation: "Ubicación actual", notSureYet: "Aún no lo sé" });
Object.assign(home.fr, { outgoingDate: "Date de départ", returningDate: "Date de retour", time: "Horaire", travelDetails: "Détails du voyage", close: "Fermer", currentLocation: "Position actuelle", notSureYet: "Je ne sais pas encore" });
