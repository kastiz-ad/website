const RULES = {
  ...
  research: /\bresearch\b|competitor research|research mission|경쟁사 조사|리서치 미션|조사해서.*준비|investigaci[oó]n/i,
...
export function destinationAwareMissionType(classifiedType, { resolvedDestination = false } = {}) {
  return classifiedType === "general_mission" && resolvedDestination ? "travel" : classifiedType;
}
