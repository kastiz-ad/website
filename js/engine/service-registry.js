...
export const SERVICE_REGISTRY = Object.freeze({
  travel:makeRegistry("travel",{requiredInformation:["origin","destination","outbound date","return date when round trip","traveler count","budget","passport or visa status only when required"],liveProviders:["Open-Meteo","Frankfurter","ExchangeRate-API Open Access","CountriesNow","OpenStreetMap Nominatim","Wikipedia"],prototypeProviders:["flight estimate adapter","hotel estimate adapter","restaurant estimate adapter","transport estimate adapter"],restrictedProviders:["airline booking","hotel booking","insurance purchase","visa submission"],resultCards:["flights","hotels","weather","currency","visa guidance","restaurants","attractions","airport transfer","local transport","packing checklist","travel insurance","emergency information","embassy or consulate guidance","lost passport steps","emergency medical guidance","provider contact checklist"],risks:["fares and availability change","entry rules are controlled by authorities","insurance exclusions apply","emergency information can be incomplete"]}),
