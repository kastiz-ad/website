...
test("public homepage references updated cache-busted assets", () => {
  assert.match(html, /style\.css\?v=20260810-journey-details-scope-fix/);
  assert.match(html, /script\.js\?v=20260810-journey-details-scope-fix/);
  assert.match(script, /home-page\.js\?v=20260810-journey-details-scope-fix/);
});
