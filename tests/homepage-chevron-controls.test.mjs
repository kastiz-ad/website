...
test("public homepage references updated cache-busted assets", () => {
  assert.match(html, /style\.css\?v=20260810-guaranteed-rich-demo/);
  assert.match(html, /script\.js\?v=20260810-guaranteed-rich-demo/);
  assert.match(script, /home-page\.js\?v=20260810-guaranteed-rich-demo/);
});
