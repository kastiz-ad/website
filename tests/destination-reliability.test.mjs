...
assert.match(indexHtml, /script\.js\?v=20260722-place-intelligence-v1/);
...
assert.match(loadingHtml, /loading\.js\?v=20260722-place-intelligence-v1/);
assert.match(resultsHtml, /results\.js\?v=20260722-world-intelligence-v10-multi-qr/);
assert.match(resultsHtml, /location\.replace\(u\.href\)/);
assert.match(resultsHtml, /no-cache, no-store, must-revalidate/);
assert.match(resultsHtml, /results\.css\?v=20260722-world-intelligence-v10-multi-qr/);
