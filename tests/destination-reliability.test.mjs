...
assert.match(indexHtml, /script\.js\?v=20260729-alpha15-travel-duration-party/);
assert.match(indexHtml, /style\.css\?v=20260729-alpha15-travel-duration-party/);
...
assert.match(resultsHtml, /results\.js\?v=20260729-alpha15-travel-duration-party/);
assert.match(resultsHtml, /location\.replace\(u\.href\)/);
assert.match(resultsHtml, /no-cache, no-store, must-revalidate/);
assert.match(resultsHtml, /results\.css\?v=20260729-alpha15-travel-duration-party/);
