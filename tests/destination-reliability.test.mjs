...
assert.match(indexHtml, /style\.css\?v=20260812-ai-modes-preview-v1/);
...
assert.match(loadingHtml, /loading\.js\?v=20260813-preview-v79/);
...
assert.match(results, /hotels:\s*12/);
