...
assert.match(resultsHtml, /results\.js\?v=20260717-41/);
assert.match(resultsHtml, /results\.css\?v=20260717-40/);
...
assert.match(resultsCss, /prototype-reference-qr \{[^}]*width: min\(280px, 82vw\)/);
...
assert.match(results, /size=600x600&amp;format=png&amp;ecc=L&amp;qzone=4/);
