...
assert.match(indexHtml, /script\.js\?v=20260803-preview-chevron-fix/);
assert.match(indexHtml, /style\.css\?v=20260803-preview-chevron-fix/);
...
assert.match(resultsHtml, /results\.js\?v=20260730-investor-demo-mode/);
assert.match(resultsHtml, /location\.replace\(u\.href\)/);
assert.match(resultsHtml, /no-cache, no-store, must-revalidate/);
assert.match(resultsHtml, /results\.css\?v=20260730-investor-demo-mode/);
