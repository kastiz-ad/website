...
test("ONE Free French price and trust labels do not fall back to English", () => {
  ...
  for (const label of ["Utilisez Modifier", "Obligatoire", "Vérification et approbation du plan", "Transfert officiel depuis l’aéroport", "Métro de Medellín + bus intégré", "Tarif point à point"]) assert.ok(source.includes(label));
