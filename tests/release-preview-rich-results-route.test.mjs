...
test("public assets use the release cache buster for the rich preview fix", () => {
  assert.match(resultsHtml, /results\.css\?v=20260810-journey-details-scope-fix/);
  assert.match(resultsHtml, /results\.js\?v=20260810-journey-details-scope-fix/);
  assert.match(resultsJs, /results-page\.js\?v=20260810-journey-details-scope-fix/);
  assert.match(homepageHtml, /style\.css\?v=20260810-journey-details-scope-fix/);
  assert.match(homepageHtml, /script\.js\?v=20260810-journey-details-scope-fix/);
});
