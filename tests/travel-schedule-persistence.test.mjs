...
test("homepage cache keys expose the current travel constraint flow", () => {
  ...
  assert.match(resultsHtmlSource, /results\.js\?v=20260910-founder-refinements-v15/);
  assert.match(resultsEntrySource, /results-page\.js\?v=20260910-founder-refinements-v15/);
