...
test("homepage cache keys expose the current travel constraint flow", () => {
  ...
  assert.match(resultsHtmlSource, /results\.js\?v=20260909-premium-travel-ui-v1/);
  assert.match(resultsEntrySource, /results-page\.js\?v=20260909-premium-travel-ui-v1/);
