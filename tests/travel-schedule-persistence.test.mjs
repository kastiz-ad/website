...
test("homepage cache keys expose the current travel constraint flow", () => {
  assert.match(indexSource, /script\.js\?v=20260915-global-dining-media-v23/);
  assert.match(scriptSource, /home-page\.js\?v=20260915-global-dining-media-v23/);
  assert.match(homeSource, /travel-constraint-parser\.js\?v=20260907-founder-qa-v20/);
  assert.match(resultsHtmlSource, /results\.js\?v=20260915-global-dining-media-v23/);
  assert.match(resultsEntrySource, /results-page\.js\?v=20260915-global-dining-media-v23/);
