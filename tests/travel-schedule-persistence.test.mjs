...
test("homepage cache keys expose the current travel constraint flow", () => {
  ...
  assert.match(resultsHtmlSource, /results\.js\?v=20260915-global-dining-media-v21/);
  assert.match(resultsEntrySource, /results-page\.js\?v=20260915-global-dining-media-v21/);
