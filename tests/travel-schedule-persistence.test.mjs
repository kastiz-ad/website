...
test("homepage cache keys expose the current travel constraint flow", () => {
  ...
  assert.match(resultsHtmlSource, /results\.js\?v=20260909-approved-travel-dashboard-v6/);
  assert.match(resultsEntrySource, /results-page\.js\?v=20260909-approved-travel-dashboard-v6/);
