...
test("homepage cache keys expose the current travel constraint flow", () => {
  assert.match(indexSource, /script\.js\?v=20260907-founder-qa-v15/);
  assert.match(scriptSource, /home-page\.js\?v=20260907-founder-qa-v15/);
  assert.match(homeSource, /travel-constraint-parser\.js\?v=20260907-founder-qa-v15/);
});
