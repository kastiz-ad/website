...
export function onePassConfig(env){
  ...
  if(production&&cfg.passkeyReauthEnabled&&(!cfg.rpId||!cfg.rpOrigin||!env.WEBAUTHN_VERIFIER))throw new ApiError(503,"unsafe_passkey_configuration","Production passkey verification requires RP ID, origin, and verifier configuration.");
